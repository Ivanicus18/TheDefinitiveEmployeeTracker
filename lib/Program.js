...
Program.prototype.finalizeOutput = function() {
    console.log(this.manager, this.interns, this.engineers);
    const pageHTML = generatePage(this.manager, this.interns, this.engineers)
    
    
    fs.writeFile('./dist/index.html', pageHTML, err => {
        if (err) throw new Error(err);

        console.log('Your webpage has been created! See the dist folder for your file!');
    });
